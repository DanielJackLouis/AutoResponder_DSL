 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.languages.autoresponder.autoResponder.impl.IntVarExpressionImpl#getVar <em>Var</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntVarExpressionImpl extends ExpressionImpl implements IntVarExpression
{
  ...
  {
    return AutoResponderPackage.Literals.INT_VAR_EXPRESSION;
  }
    ...
    if (var != null && var.eIsProxy())
    {
      ...
      if (var != oldVar)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AutoResponderPackage.INT_VAR_EXPRESSION__VAR, oldVar, var));
      }
    }
    return var;
  }
  ...
  public void setVar(VariableDeclaration newVar)
  {
    ...
    var = newVar;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AutoResponderPackage.INT_VAR_EXPRESSION__VAR, oldVar, var));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AutoResponderPackage.INT_VAR_EXPRESSION__VAR:
